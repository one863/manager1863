		...
		<div className="flex flex-col h-full bg-white animate-fade-in">
			...
			<div className="bg-white p-4 pt-6 sticky top-0 z-10 border-b border-gray-100">
				<div className="flex items-start justify-between mb-4">
                    <button 
                        onClick={onClose}
                        className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-600 hover:text-ink hover:bg-gray-100 transition-all"
                    >
                        <ArrowLeft size={20} />
                    </button>
				...
				{activeTab === "squad" ? (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3 min-w-0">
                                        ...
                                        <div className="truncate">
                                            ...
                                            <p className="text-[9px] text-gray-600 truncate">{player.firstName}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-8 text-center">
                                        <span className={`font-black font-mono text-sm ${
                                            ...
                                            player.skill >= 12 ? "text-green-600" : "text-gray-600"
                                        }`}>
					...
					<div className="space-y-4">
						<div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
							<h3 className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] mb-4">Direction Sportive</h3>
							<div className="flex items-center gap-4">
								...
								<div>
									...
									<p className="text-[10px] text-gray-600 font-bold uppercase tracking-wider">Entraîneur Principal</p>
								</div>
							</div>
						</div>
						...
						<div className="grid grid-cols-2 gap-4">
							<div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
								<span className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] block mb-2">Budget</span>
							...
							<div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm">
								<span className="text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] block mb-2">Réputation</span>
								<div className="flex items-center gap-2">
