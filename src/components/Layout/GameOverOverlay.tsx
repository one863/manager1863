      ...
      <div className="bg-white p-8 rounded-2xl shadow-2xl border-4 border-red-500 flex flex-col items-center gap-6 max-w-sm">
        ...
        <div>
          ...
          <p className="text-sm text-ink-light leading-relaxed">
            Vos dirigeants ont perdu patience. L'aventure s'arrête ici pour vous à la tête du club. 
            Votre nom restera dans les archives, mais le banc est désormais libre.
          </p>
        </div>
