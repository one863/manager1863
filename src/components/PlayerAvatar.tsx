    ...
    >
      ...
      {facialIdx > 0 && (
        <g fill={hair} opacity="0.9">
          {facialIdx === 1 && <path d="M 35 58 Q 50 62 65 58 Q 50 65 35 58" />}{' '}
          {/* Moustache fine */}
          {facialIdx === 2 && <path d="M 30 55 Q 50 68 70 55 Q 50 75 30 55" />}{' '}
          {/* Moustache épaisse */}
          {facialIdx === 3 && (
            <path d="M 25 50 Q 50 90 75 50 L 70 45 Q 50 80 30 45 Z" />
          )}{' '}
          {/* Barbe complète */}
          {facialIdx === 4 && (
            <g>
      ...
      {/* Cheveux */}
      <g fill={hair}>
        {hairIdx === 0 && <path d="M 15 40 Q 50 0 85 40 Q 50 15 15 40" />}{' '}
        {/* Court simple */}
        {hairIdx === 1 && (
          <path d="M 15 45 Q 50 -10 85 45 Q 70 20 50 15 Q 30 20 15 45" />
        )}{' '}
        {/* Volume haut */}
        {hairIdx === 2 && (
          <path d="M 10 50 Q 50 5 90 50 Q 95 60 85 40 Q 50 20 15 40 Q 5 60 10 50" />
        )}{' '}
        {/* Ébouriffé */}
        {hairIdx === 3 && (
          <path d="M 15 40 Q 50 10 85 40 L 90 60 Q 50 50 10 60 Z" />
        )}{' '}
        {/* Raie au milieu */}
        {hairIdx === 4 && <circle cx="50" cy="20" r="10" />}{' '}
        {/* Chauve (juste haut) */}
        {hairIdx === 5 && (
