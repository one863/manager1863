...
interface LiveMatchState {
  ...
  initializeLiveMatch: (matchId: number, homeTeam: any, awayTeam: any, result: any, saveId: number, startMinute?: number) => Promise<void>;
...
export const useLiveMatchStore = create<LiveMatchState>((set, get) => ({
  ...
  initializeLiveMatch: async (matchId, homeTeam, awayTeam, result, saveId, startMinute = 0) => {
    const initialData = { matchId, homeTeam, awayTeam, result, currentMinute: startMinute };
