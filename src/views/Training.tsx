...
import { AlertCircle, CheckCircle2, ChevronUp, Dumbbell, Briefcase, Users, Clock, XCircle, ArrowUp, ArrowDown } from "lucide-preact";
							...
							return (
								...
								>
									<div className="flex justify-between items-center">
										<div className="flex items-center gap-3">
											{member ? (
												<PlayerAvatar dna={member.dna} isStaff size={48} className="shrink-0" />
											) : (
